  ...
  return (
    ...
    <>
      <div className='flex flex-row-reverse items-start md:items-center justify-center h-[90vh]   '>
          ...
          <div className='flex items-center place-content-center   place-self-center md:place-self-start lg:mt-20 md:ml-48 h-[650px] w-[480px] min-w-[430px]  bg-[#3D93F5] rounded-xl shadow-gray-600 shadow-lg'>
